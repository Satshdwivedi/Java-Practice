...
public class Task9 {
    public static void main(String[] args) {
        ...
        books.add(new Book(101, "Pralay", "Nagraj", "Comics", 3));
        books.add(new Book(102, "Vinash", "Dhruv", "Comics", 4));
        books.add(new Book(103, "Jaljala", "Doga", "Comics", 7));
        books.add(new Book(104, "Kohram", "Permanu", "Comics", 2));
        ...
        // Student s = new Student(11, "Ram", "ram@gmail.com", 9876543210L);
        ...
        for (int i = 0; i < borrow.size(); i++) {
            if (borrow.get(i).member.id == m.id && borrow.get(i).book.id == b.id) {
                found = true;
                b.copies++;
                borrow.remove(i);
                break;
